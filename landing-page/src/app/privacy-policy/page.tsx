const PrivacyPolicy = () => {
    return (
      <div className="max-w-3xl mx-auto px-6 py-12 text-gray-800">
        ...
        <p className="mb-6">
          Continuum (“we”, “our”, or “us”) values your privacy. This Privacy Policy explains how
          information is handled when you use our mobile application.
        </p>
  
        <h2 className="text-xl font-semibold mb-3">1. Information We Collect</h2>
        <p className="mb-6">
          Continuum does not require you to create an account. We do not collect personally
        ...
        <p className="mb-6">
          ...
          generate a response. This data is transmitted securely and is not stored by Continuum.
        ...
        <p className="mb-6">
          Continuum relies on the OpenAI API to generate responses. OpenAI may process your input text
        ...
        <p className="mb-6">
          Continuum is not directed to individuals under 13. We do not knowingly collect personal
